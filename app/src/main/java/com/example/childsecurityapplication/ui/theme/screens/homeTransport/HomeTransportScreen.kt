...
@Composable
fun HomeTransportScreen(navController: NavHostController) {
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Enter time of arrival*") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
        ...
        Button(onClick = {
            ...
            homeTransportRepository.saveHomeTransport(
...
@Composable
fun Hometprev() {
   HomeTransportScreen (rememberNavController())
